...
WAP that uses a function template called maximum to determine the larger of two arguments. Test the program using integer, character and floating-point number arguments.

\section*{\normalsize 2. Task :}
    
Make a template funtion to compute maximum between two arguments passed to it.
