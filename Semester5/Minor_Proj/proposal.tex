...
\begin{tabular}{ |m{0.25\textwidth}|m{6em}|m{7em}| }
    ...
    \hline
    \begin{center}Abhishek Gupta\end{center} & \begin{center}19BCS4579\end{center} & \raisebox{-0.5em}{\includegraphics[scale=0.09]{private/aSign.jpeg}} \\
    \hline
    \begin{center}Khushwant Rathod\end{center} & \begin{center}19BCS4644\end{center} & \raisebox{-1em}{\includegraphics[scale=0.07]{private/kSign.jpeg}}\\
    \hline
    \begin{center}Rishabh Anand\end{center} & \begin{center}19BCS4525\end{center} & \raisebox{-1em}{\includegraphics[scale=0.05]{private/rishSign.jpg}} \\
    \hline
    \begin{center}Udita Mitra\end{center} & \begin{center}19BCS4662\end{center} & \raisebox{-1em}{\includegraphics[scale=0.2]{private/uSign.jpeg}} \\
    \hline
    \begin{center}Vandana Chauhan\end{center} & \begin{center}19BCS4532\end{center} & \raisebox{-1em}{\includegraphics[scale=0.15]{private/vSign.png}} \\
    \hline
\end{tabular}
\end{center}
